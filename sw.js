...
const CACHE = 'fiscan-v13';
const SHELL = [
  './', 'index.html', 'css/styles.css', 'js/app.js', 'js/db.js', 'js/parsers.js', 'js/ocr.js',
  'js/reminder-core.js', 'js/sanitize.js', 'js/crypto.js', 'js/preprocess.js', 'js/items.js', 'js/inventory.js', 'js/anaf.js', 'js/checks.js', 'js/copy.js', 'js/projects.js', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-192.png', 'icons/icon-512.png',
];
