...
Datele sunt salvate **doar pe telefon** (IndexedDB). Nu există server și niciun cont.
...
## OCR
Recunoașterea textului rulează direct pe telefon cu [Tesseract.js](https://github.com/naptha/tesseract.js) (română + engleză). La prima folosire se descarcă ~10 MB de date de limbă, păstrate apoi în cache. Pentru rezultate bune: bonul întins, lumină bună, poza cât mai dreaptă. Verifică valorile înainte de salvare. Tot ce completezi tu nu este suprascris de OCR.
