...
export const SUBCATS = [
  ...
  { key: 'paint', group: 'house', name: 'Materiale – vopsele & finisaje', color: '#ab47bc', words: ['vopsea', 'lavabil', 'lavabila', 'email', 'grund', 'pensula', 'pensule', 'trafalet', 'diluant', 'lac', 'bait', 'tencuiala decorativa', 'banda mascare', 'folie protectie', 'hartie abraziva', 'smirghel', 'tava vopsea'] },
  { key: 'garden', group: 'garden', name: 'Grădină', color: '#558b2f', words: ['furtun', 'gazon', 'seminte gazon', 'pamant flori', 'substrat', 'ghiveci', 'ingrasamant', 'grebla', 'foarfeca gradina', 'stropitoare', 'flori', 'rasad', 'motocoasa', 'sapaliga', 'lopata', 'roaba', 'tarus'] },
  { key: 'cleaning', group: 'household', name: 'Curățenie & detergenți', color: '#00897b', words: ['detergent', 'balsam rufe', 'clor', 'domestos', 'bref', 'laveta', 'lavete', 'burete', 'bureti', 'matura', 'maturi', 'faras', 'mop', 'galeata', 'saci menajeri', 'saci gunoi', 'saci', 'hartie igienica', 'prosoape hartie', 'servetele', 'dezinfectant', 'odorizant', 'ariel', 'persil', 'lenor', 'fairy', 'pronto', 'vanish', 'calgon', 'tablete vase', 'solutie geamuri', 'solutie curatat', 'mr proper', 'cilit', 'perie', 'manusi menaj'] },
  { key: 'hygiene', group: 'household', name: 'Igienă personală', color: '#ec407a', words: ['sampon', 'gel dus', 'sapun', 'pasta dinti', 'periuta', 'deodorant', 'spuma ras', 'aparat ras', 'lame ras', 'crema', 'absorbante', 'scutece', 'tampoane', 'dischete', 'betisoare', 'apa micelara', 'antiperspirant'] },
  { key: 'dairy', group: 'food', name: 'Lactate & ouă', color: '#fbc02d', words: ['lapte', 'unt', 'iaurt', 'branza', 'smantana', 'cascaval', 'oua', 'ou', 'telemea', 'kefir', 'sana', 'mozzarella', 'parmezan', 'frisca', 'urda', 'cas', 'margarina', 'zuzu', 'napolact', 'danone', 'covalact', 'olympus', 'hochland'] },
  { key: 'meat', group: 'food', name: 'Carne & pește', color: '#c62828', words: ['carne', 'pui', 'piept', 'pulpe', 'porc', 'vita', 'vitel', 'miel', 'curcan', 'carnati', 'carnaciori', 'salam', 'sunca', 'parizer', 'crenvursti', 'bacon', 'kaiser', 'mici', 'tocatura', 'tocata', 'ceafa', 'cotlet', 'muschi', 'pastrama', 'peste', 'somon', 'ton', 'macrou', 'hering', 'creveti', 'pate', 'lebar', 'caltabos', 'toba'] },
  { key: 'bakery', group: 'food', name: 'Panificație', color: '#a1887f', words: ['paine', 'franzela', 'chifla', 'chifle', 'covrig', 'covrigi', 'croissant', 'lipie', 'bagheta', 'cozonac', 'blat', 'toast', 'baton', 'painici', 'pateu', 'placinta', 'foietaj'] },
  { key: 'produce', group: 'food', name: 'Fructe & legume', color: '#43a047', words: ['mere', 'mar', 'banane', 'banana', 'rosii', 'cartofi', 'ceapa', 'usturoi', 'castraveti', 'ardei', 'portocale', 'lamai', 'lamaie', 'morcovi', 'varza', 'salata', 'spanac', 'dovlecei', 'vinete', 'struguri', 'pere', 'piersici', 'kiwi', 'ciuperci', 'patrunjel', 'marar', 'pepene', 'capsuni', 'afine', 'avocado', 'broccoli', 'conopida', 'telina', 'mandarine', 'grepfrut', 'prune', 'cirese', 'visine', 'caise', 'ridichi', 'sfecla', 'praz'] },
  { key: 'drinks', group: 'food', name: 'Băuturi', color: '#1e88e5', words: ['apa minerala', 'apa plata', 'apa', 'suc', 'cola', 'pepsi', 'fanta', 'sprite', 'bere', 'vin', 'cafea', 'ceai', 'energizant', 'redbull', 'red bull', 'borsec', 'dorna', 'bucovina', 'aqua carpatica', 'izvorul', 'whisky', 'vodka', 'rom', 'tuica', 'palinca', 'lichior', 'sampanie', 'prosecco', 'nectar', 'limonada', 'ursus', 'timisoreana', 'heineken', 'tuborg', 'bergenbier', 'stella', 'jacobs', 'lavazza', 'nescafe', 'doncafe', 'tchibo', 'lipton', 'schweppes', 'mirinda', '7up', 'coca'] },
...
// Grupe mari peste subcategorii: în analiză vezi întâi totalul pe grupă, apoi detaliile.
...
export const groupOf = (subKey) => GROUPS.find((g) => g.key === subcatByKey(subKey).group) || GROUPS[GROUPS.length - 1];
