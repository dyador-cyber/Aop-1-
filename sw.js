...
const CACHE = 'bonuri-v4';
const SHELL = [
  './', 'index.html', 'css/styles.css', 'js/app.js', 'js/db.js', 'js/parsers.js', 'js/ocr.js',
  'js/reminder-core.js', 'js/sanitize.js', 'js/crypto.js', 'js/preprocess.js', 'js/items.js', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-192.png', 'icons/icon-512.png',
];
